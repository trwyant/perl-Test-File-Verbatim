...
sub version_from {
    return 'lib/Test/File/Verbatim.pm';
}
...
My::Module::Meta - Information needed to build Test::File::Verbatim
...
This module centralizes information needed to build C<Test::File::Verbatim>. It
is private to the C<Test::File::Verbatim> package, and may be changed or
...
modules required to build the C<Test::File::Verbatim> package, suitable for
...
the modules required to run the C<Test::File::Verbatim>
