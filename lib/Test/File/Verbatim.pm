...
sub all_verbatim_ok {
    ...
    defined $opt->{exclude}
	or $opt->{exclude} = \&default_exclude;
    my $rslt = 1;
...
If unspecified, this defaults to a subroutine that mimics the default
behavior of F<ack>. This subroutine is extracted from the
C<--ignore-file> specifications in
L<App::Ack::ConfigDefault|App::Ack::ConfigDefault> by
...
=head2 default_exclude

This subroutine is B<not> a test. It is the default exclusion code for
the L<all_verbatim_ok()|/all_verbatim_ok>.
